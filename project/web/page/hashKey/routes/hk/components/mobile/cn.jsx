                ...
                {this.state.langChangeModal ? 
                    <Row className="langChangeModal">
                        <Row type="flex" justify="center">
                            <Col span={10} className="title">语言</Col>
                        </Row>
                    </Row> : null
                }
                    ...
                    <Col span={16}>
                        {!this.state.showMoreAbout ?
                            <Row>
                                ...
                                <a href="javacript:;" onClick={() => { this.setState({ showMoreAbout: true }) }} className="seeMore">
                                    <img src={showBtn} />
                                </a>
                            </Row> :
                            <Row>
                                <img src={aboutFullTextImg} />
                                <a href="javacript:;" onClick={() => { this.setState({ showMoreAbout: false }) }} className="seeMore">
                                    <img src={hideBtn} />
                                </a>
                            </Row>
                        }
