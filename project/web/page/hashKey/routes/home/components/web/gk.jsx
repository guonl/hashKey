                    ...
                    <Col span={23}>
                        ...
                        <Col span={13}>
                            <Row type="flex" justify="end" className="menuList">
                                ...
                                <div className={this.state.activeMenu == "assets" ? "eachMenu active" : "eachMenu"} onClick={() => this.goToHref.call(this, "assets")}>關注領域</div>
                ...
                <Row id="team" className="teamFrame" type="flex" justify="center">
                    <Col lg={22} xl={16} style={{ maxWidth: 1200 }}>
                        ...
                        <Row className="member" type="flex" justify="center">
                            <Col span={24}>
                                <Row type="flex" justify="space-around" className="member">
                                    ...
                                    <Popover placement="top" content={
                                        <div>25年投資銀行經驗，曾服務於瑞銀集團投資銀行倫敦、東京、北京及香港，前亞太區資本市場主管、前瑞銀證券董事會成員。領導過百項大型融資和併購業務項目，並於衍生與另類私募產品市場開拓了大量創新業務及核心盈利模式。英國倫敦大學帝國學院計算機科學碩士。</div>
                                    }>
                                        <Col span={6} style={{ textAlign: 'center' }}>
                        ...
                        <Row className="senior">
                            <Col span={8} className="title">高管團隊</Col>
